...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      resizeToAvoidBottomInset: false, // Ensures background and copyright stay static
      body: Stack(
        children: [
          // Static background image that fills the screen
          Positioned.fill(
            child: Image.asset('assets/homescreen.png', fit: BoxFit.cover),
          ),
          // Content that scrolls (including text fields)
          Center(
            child: SingleChildScrollView(
              padding: const EdgeInsets.symmetric(horizontal: 30.0),
              child: Column(
                ...
                children: [
                  ...
                  // MODIFIED: Reduced space after logo
                  ...
                  // MODIFIED: Reduced space after title
                  ...
                  // to ensure the last elements don't get hidden by the keyboard.
                  // The amount here might need fine-tuning based on average keyboard height.
                  const SizedBox(height: 80), // Increased from 50 to provide more scroll room
                ],
              ),
            ),
          ),
          ...
          Positioned(
            bottom: 20.0, // Adjust this value for desired spacing from the bottom
            left: 0,
            right: 0,
            child: const Text(
              '© Ferrero 2022. All rights reserved.',
